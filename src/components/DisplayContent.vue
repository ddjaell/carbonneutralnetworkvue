<template>
  <v-card>
    <v-toolbar dark>
      ...
      <v-spacer/>
      <v-btn v-if="$store.state.adminYn" @click="articleWrite" icon><v-icon>mdi-pencil</v-icon></v-btn>
      <v-btn v-if="$store.state.adminYn" @click="remove" icon><v-icon>mdi-delete</v-icon></v-btn>
